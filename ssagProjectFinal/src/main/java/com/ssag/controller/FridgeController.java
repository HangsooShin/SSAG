...
//	}
	...
	@ResponseBody
	public Model searchresult(@RequestParam(value = "similar") String similar, Model model) {
		List<SimilarnameVo> similarnameVo = fridgeService.getKeyword(similar);
		System.out.println("여기 나오나1");
//		System.out.println(similarnameVo); 들어있따.
		model.addAttribute("list", similarnameVo);
