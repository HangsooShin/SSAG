...
public class FridgeController {
  ...
  public String changeFridgeBox3(FridgeBoxVo originalfridgeBoxVo, FridgeBoxVo fridgeBoxVo, String ingredientcreateddate,
      String expiredate,
  ...
  public String addFridge(Authentication authentication, @AuthenticationPrincipal UserVo user, Model model,
    ...
    memoList = userService.memoList(fridgecode, usercode);
  ...
  public List<CookIngredientListVo> searchresult1(String similar, Model model, SimilarnameVo similarnameVo) {
    ...
    // HashMap<String, ArrayList<IngredientVo>> keyIdx =
    // ingredientService.joinDic(similar);
  ...
  public String webBasket(Model model, @AuthenticationPrincipal UserVo user) {

    List<IngredientVo> ingredientchecklist = ingredientService.ingredientchecklist(user.getUsercode(),
        user.getFridgecode());
    List<CookbasketListVo> cookbasket = ingredientService.cookbasket(user.getUsercode(),
        user.getFridgecode());
  ...
  @GetMapping("/price")
  // @ResponseBody
  public String ingredientmerchandise(Model model, @AuthenticationPrincipal UserVo user) {
    List<MerchandiseVo> ingredientprice = ingredientService.ingredientprice(user.getUsercode(), user.getFridgecode());
